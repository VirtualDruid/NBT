...
public class MCAFileTest extends MCATestCase {
    ...
    public void test_version18ChunkFormat() {
        MCAFile f = assertThrowsNoException(() -> MCAUtil.read(copyResourceToTmp("r.0.-1.mca")));
        Chunk c = f.getChunk(0, 28);
        assertNull(c.getEntities());
        assertNotNull(c.getPostProcessing());
        assertNotNull(c.getHeightMaps());
        assertNotNull(c.getStructures());
        assertNotNull(c.getLiquidTicks());
        assertNotNull(c.getHeightMaps());
//        assertNotNull(c.getEntities());
        assertNotNull(c.getTileEntities());
        assertNotNull(c.getTileTicks());
